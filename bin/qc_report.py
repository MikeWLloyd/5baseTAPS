...
# We use a CDN link with an integrity hash — this is the standard
# offline-friendly approach; paste the actual minified CSS below if
# truly airgapped operation is needed.
BOOTSTRAP_CSS = """
